...
public class CompteSimple extends Compte implements ISolvable {
   ...
   * 
   * @param dec Autorisation de découvert
   */
   ...
   * 
   * @param decouvert Autorisation de découvert
  ...
  public void retirer(float montant) {
    ...
    if (montant > 0) {
      ...
      // montant >= this.solde
        ...
        System.err
            .println("Opération impossible. Vous dépasseriez votre autorisation de découvert");
      }
    }
    // montant <= 0
    else {
  ...
  public String toString() {
    ...
    return "Compte simple n°" + this.getCode() + ", solde = " + this.solde + ", découvert = "
        + this.decouvert;
  }
